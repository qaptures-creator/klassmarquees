...
export default function PrivacyPage() {
  return (
    <section className="bg-navy-deep pb-24 pt-40 sm:pb-28 lg:pb-32">
      <Container className="max-w-3xl">
        <Reveal>
          <p className="text-xs font-semibold uppercase tracking-[0.32em] text-accent">Privacy Policy</p>
        </Reveal>
        <Reveal delay={0.08} variant="mask">
          <h1 className="mt-5 text-h1 font-serif font-medium text-ivory">Privacy Policy</h1>
        </Reveal>

        <Reveal delay={0.16}>
          <div className="prose-content mt-10 space-y-6 text-ivory/75">
            <p>
            ...
            <h2 className="pt-4 font-serif text-h3 font-medium text-ivory">What we collect</h2>
            <p>
            ...
            <h2 className="pt-4 font-serif text-h3 font-medium text-ivory">How we use it</h2>
            <p>
              Enquiry information is used only to contact you about your
              event and is not sold or shared with third parties for
              marketing purposes.
            </p>
            <h2 className="pt-4 font-serif text-h3 font-medium text-ivory">Contact us</h2>
            <p>
