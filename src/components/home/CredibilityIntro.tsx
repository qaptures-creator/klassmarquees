...
export default function CredibilityIntro() {
  return (
    <section id="credibility" className="bg-navy-deep py-24 sm:py-28 lg:py-32">
      <Container>
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-7 lg:col-start-6">
            ...
            <Reveal delay={0.2}>
              <div className="mt-10 grid grid-cols-1 gap-6 border-t border-ivory/10 pt-8 sm:grid-cols-3">
                {phoneLines.slice(0, 3).map((line) => (
                  <div key={line.tel}>
                    ...
                    <a
                      href={`tel:${line.tel}`}
                      className="mt-2 block font-serif text-xl text-ivory transition-colors hover:text-accent"
                    >
                      {line.display}
                    </a>
                  </div>
