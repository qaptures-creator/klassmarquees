        ...
        <div className="mt-16 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-0">
          {klassExperience.map((step, i) => (
            <Reveal key={step.index} delay={i * 0.1}>
              <div className="border-l border-ink/15 pl-6 lg:mr-6 lg:min-h-[13rem]">
                <span className="font-serif text-h2 text-bronze">{step.index}</span>
                <h3 className="mt-4 font-serif text-h3 font-medium text-ink">{step.title}</h3>
